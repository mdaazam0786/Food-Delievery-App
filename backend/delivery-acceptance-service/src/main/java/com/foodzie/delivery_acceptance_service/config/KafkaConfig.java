...
public class KafkaConfig {
    ...
    // ── Consumer — delivery-events (DeliveryMatchingEvent) ───────────────────

    @Bean
    public ConsumerFactory<String, DeliveryMatchingEvent> deliveryMatchingConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, DeliveryMatchingEvent>
    deliveryMatchingListenerContainerFactory() {
